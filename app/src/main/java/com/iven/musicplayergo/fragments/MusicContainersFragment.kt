...
class MusicContainersFragment : Fragment(),
    ...
    override fun onAttach(context: Context) {
        ...
        Log.d("onAttachToActivyt","onAtach")
...
//
//
//        Log.d("MusicList", mList!!.size.toString() + " music list size musicContainer")
//        Log.d("MusicList", mSorting.toString() + " mSorting musicContainer ")
//
//        finishSetup()
    }
