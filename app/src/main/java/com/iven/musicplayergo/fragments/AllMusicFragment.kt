...
class AllMusicFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    override fun onAttach(context: Context) {
        ...
        try {
            mUIControlInterface = (requireActivity() as MainActivity) as UIControlInterface
            mMediaControlInterface = (requireActivity() as MainActivity) as MediaControlInterface
...
//        mMusicViewModel.deviceMusic.observe(requireActivity()) { it ->
//            if (it != null) {
//                mAllMusic = it
//                finishSetup()
//                Log.d("MusicListSize", mAllMusic!!.size.toString() + " size music list")
//
//            }
//        }
